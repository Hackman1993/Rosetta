...
//
//namespace rosetta {
//  mysql_statement::mysql_statement(mysql_connection &connection, const sahara::string& sql):
//    sql_statement(connection, sql), statement_(connection.connection_->prepareStatement(sql.to_std())) {

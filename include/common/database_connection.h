...
namespace rosetta {
  ...
  public:
    database_connection(std::string_view host, unsigned short port, std::string_view database, std::string_view username, std::string_view password) : database_connection_base(host, port, database, username, password){};

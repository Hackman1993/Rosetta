...
namespace rosetta {
    ...
    public:
        database_connection_base(const sahara::string& host, unsigned short port, const sahara::string& username,
                                 const sahara::string& password, const sahara::string& database) :

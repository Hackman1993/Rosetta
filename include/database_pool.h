...
//  class database_pool {
//  public:
//    database_pool(std::size_t pool_size, const sahara::string& host, std::uint16_t port, const sahara::string& username, const sahara::string& password, const sahara::string& database):
